...
<?php a_select('appMode', 'Как открывать приложение с сайта', [
    'window' => 'Отдельным окном на домене приложения — работает вход через Telegram',
    'modal'  => 'Во всплывающем окне поверх сайта — красивее, но Telegram нужно настроить',
], $b['appMode'] ?? 'window',
 'Вход через Telegram привязан к одному домену — тому, что прописан у бота в BotFather. Сейчас это домен приложения, поэтому по умолчанию оно открывается отдельным окном. Пропишете свой домен в BotFather — можно переключить на всплывающее окно.'); ?>
