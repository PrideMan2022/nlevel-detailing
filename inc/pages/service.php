...
$want = [
    ...
    // Своих снимков по антигравийке, керамике и мойке пока нет. Добираем
    // оклейкой: это тоже плёнка и тот же бокс, а не выдача чужой услуги
    // за свою. Как появятся профильные кадры — первым в списке станет свой.
