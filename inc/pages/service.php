...
$want = [
    ...
    // Своих снимков по керамике и мойке пока нет — добираем полировкой
    // и оклейкой: это тот же бокс и родственная работа, а не выдача
    // чужой услуги за свою. Появятся профильные кадры — станут первыми.
    'antigraviynaya-plenka'  => ['Антигравийка', 'Оклейка'],
    'tonirovka'              => ['Оптика', 'Оклейка'],
    'mojka'                  => ['Полировка', 'Оклейка'],
    'polirovka'              => ['Полировка', 'Оклейка'],
    'keramika'               => ['Полировка', 'Оклейка'],
