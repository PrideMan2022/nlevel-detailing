...
// Разделы галереи — как на карточке организации в Яндексе: Оклейка, Мойка,
// Студия, Детали. Профильных кадров по каждой услуге в этом наборе нет,
// поэтому вторым и третьим идут родственные разделы, а «Студия» замыкает:
// снимки бокса подходят любой услуге и не выдают чужую работу за свою.
$want = [
    'oklejka-plenkoj'        => ['Оклейка', 'Детали', 'Студия'],
    'antigraviynaya-plenka'  => ['Оклейка', 'Детали', 'Студия'],
    'tonirovka'              => ['Оклейка', 'Детали', 'Студия'],
    'mojka'                  => ['Мойка', 'Студия'],
    'polirovka'              => ['Детали', 'Оклейка', 'Студия'],
    'keramika'               => ['Оклейка', 'Мойка', 'Студия'],
    'himchistka'             => ['Мойка', 'Студия'],
    'shumoizolyaciya'        => ['Детали', 'Студия'],
][$slug] ?? [];
$byCat = [];
